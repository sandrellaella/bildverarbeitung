...
Zwei Paper die in der Literaturrecherche vorgestellt wurden
...
\caption{Ridge Point Detection TODO nähere Beschreibung}
...
zu untersuchen. Dabei wählt man eine Richtung parallel zur x-Achse und eine Richtung parallel zur y-Achse des untersuchten Bildes.
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{./fig/muster_strong_good}
\caption{Muster für Indiz auf einen Gebirgskamm. Diese beiden Muster sind ein eindeutiger (\emph{strong}, linke Abbildung) und ein guter (\emph{good}, rechte Abbildung) Indiz für einen Punkt auf dem Gebirgskamm.}
\label{fig:muster_strong_good}
\end{figure}
Es existieren insgesamt vier Muster, die auf einen Gebirgskamm deuten. 
