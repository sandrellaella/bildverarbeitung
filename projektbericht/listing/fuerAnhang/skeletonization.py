...
Eine anschliessende Differenzbildung zwischen Gradientenbetrag und
...
class Skeleton():
    ...
    """Berechnung des Distanzskeletts. Vier Schritte: Berechnen der 
    Distance Map, bestimmen des Gradientenbetrags der Distance Map, 
    segmentieren des Gradientenbetrags und Differenzbildung zwischen 
    Distancemap und Gradientenbetrag (segmentiert)"""
    ...
    def pruning(self,skeleton_img,sigma):
        ...
        ndimage.gaussian_gradient_magnitude(skeleton_img_mat,
                                                sigma,gradient_output)
        #Normalisierung
